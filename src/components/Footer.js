...
import {  Heading, Text, Grid, GridItem, Divider,Stack } from "@chakra-ui/react";
      ...
      <footer>
        ...
        >
          ...
          >
            ...
            <Heading as='h3' paddingBottom={paddingHeading} align={align}>Henry Castillo</Heading>
            <Text fontSize={{ md: 'sm', base: 'xs' }} textStyle='body' paddingRight={paddingText} align={align}>Crafting seamless user experiences and building robust,
          ...
          <GridItem
            ...
            <Heading as='h3' paddingBottom={paddingHeading} align={align}> Socials</Heading>
